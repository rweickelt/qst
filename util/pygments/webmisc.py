...
class QmlLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            # QML insertions
            (r'^(import)(\s+)(\w*)(\s+)(\d+\.\d+)',
                bygroups(Keyword, Text.Whitespace, Name.Class, Text.Whitespace, Name)),
            (r'\b(id)(\s*)(:)',
                bygroups(Keyword, Text.Whitespace, Punctuation),
                'slashstartsregex'),
            (r'(alias|as|on|property|readonly)\b', Keyword),
            (r'(bool|list|real|string)\b', Keyword.Type),
            (r'\b[A-Z]\w*', Name.Class, 'slashstartsregex'),

            # the rest from JavascriptLexer
            (r'(for|in|while|do|break|return|continue|switch|case|default|if|else|'
             r'throw|try|catch|finally|new|delete|typeof|instanceof|void|'
             r'this)\b', Keyword, 'slashstartsregex'),
            (r'(var|let|with|function)\b', Keyword.Reserved, 'slashstartsregex'),
